...
def lunges():
    ...
    with mp_pose.Pose(min_detection_confidence=0.5,
        ...
        while cap.isOpened():
            ...
            try:
                ...
                if (angle_left > 120 and angle_left > 120) and (angle_left_upper > 160 and angle_right_upper > 160):
                    stage = "up"
                        ...
                        angle_left_upper < 100 and angle_right_upper > 170)) or (
                              (angle_left < 90 and angle_right < 90) and (
                              angle_left_upper > 170 and angle_right_upper < 100))) and stage == "up":
                    stage = "down"
                    counter += 1
                    print(counter)
            ...
            cv2.putText(image, str(counter) + " " + stage, (10, 60),
